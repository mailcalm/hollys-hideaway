      ...
      <div className="space-y-6">
        {[
          ...
          },
          {
            ...
            price: "£45",
            time: "1 hour 30 mins",
            text: "A maintenance treatment designed to restore strength, balance and structure as your natural nails grow. Existing builder gel is gently refined, the shape is rebalanced, and the apex is carefully rebuilt to support the nail’s natural stress points. Length can be adjusted if needed. Followed by a hot towel, exfoliating hand scrub and relaxing hand massage, before fresh builder gel is applied to reinforce and perfect the structure. Completed with luxury hand cream, nourishing oil and fragrance spritz.",
            extras: [
              "Gel Colour Overlay + £5",
              "French Tip + £5",
              "Minimal Nail Art + £5",
